...
def getPostData(post, jsonResult, cnt):
    ...
    #딕셔너리 생성
    dic={'cnt':cnt, 'title':title, 'link':link, 'description':description, 'bloggername':bloggername,'bloggerlink':bloggerlink}
    jsonResult.append(dic)


#[code 1]
def main():
    node='blog' #1.크롤링할 대상[ 네이버 제공하는 검색대상: 1.news 2. blog 3. shop 등등
