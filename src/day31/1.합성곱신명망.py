...
#모델 훈련
history=model.fit(x_train_in,y_train,validation_data=(x_vaild_in,y_valid),epochs=10)
...
history= model.fit({'inputs':x_train_in},{'digit_dense':y_train, 'odd_dense':y_train_odd},
                  validation_data=({'inputs':x_vaild_in},{'digit_dense':y_valid, 'odd_dense':y_valid_odd}),epochs=10)
